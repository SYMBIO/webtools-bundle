 ...
 * Loads initial data
 */
class ThumbnailerRefreshCommand extends ContainerAwareCommand
{
    /**
     * @see Command
     */
    protected function configure()
    {
        $this
            ...
            ->setName('symbio:webtools:thumbnailer:refresh')
            ->setDescription('Refresh generated thumbnails')
        ;
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach($baseDirs as $baseDir) {
            try {
                $output->writeln(sprintf('Refreshing directory "%s":', $baseDir));
                $thumbnailer->refreshAll($baseDir, $output);
